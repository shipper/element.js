(function() {
  ...
  exports.get = function(org, library) {
    var map_key;
    if (library == null) {
      library = void 0;
    }
    map_key = "$$resource";
    return TypeRevisionResource.findRevision(map_key, 0, org, 'key', library).fail(function() {
      var instance;
      ...
      return TypeRevisionResource.save(instance);
    });
  };
